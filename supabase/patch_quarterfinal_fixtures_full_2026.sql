-- Gold Cup 2026 — quarter-final teams + kickoffs (paste in Supabase SQL Editor)
-- QF1 Blue Phoenix v EAS Saints · QF2 Sabis v Star · QF3 MTK v 132-134 · QF4 Sahil v Sambo
...
update public.matches set
  ...
  scheduled_at = '2026-06-20 16:00:00+04'::timestamptz,
  sort_order = 100
...
update public.matches set
  ...
  scheduled_at = '2026-06-20 17:30:00+04'::timestamptz,
  sort_order = 101
...
update public.matches set
  ...
  scheduled_at = '2026-06-20 19:00:00+04'::timestamptz,
  sort_order = 102
...
update public.matches set
  ...
  scheduled_at = '2026-06-20 20:30:00+04'::timestamptz,
  sort_order = 103
